...
import { useStore } from '../../hooks/useStore'; // useStore 훅 추가
...
const MenuDetailPage = () => {
  ...
  const { getMenuById } = useStore(); // StoreProvider에서 getMenuById 함수 가져오기

  // StoreProvider의 getMenuById 함수를 사용하여 메뉴 데이터 가져오기
  ...
  return (
    ...
    <ImageButtonContainer>
      <MenuImage src={menu.imgUrl} alt={menu.name} />
      <BackButton onClick={() => navigate('/')}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M11.7 18.3C11.9833 18.5833 12.0667 18.9 11.95 19.25C11.8333 19.6 11.6 19.8417 11.25 19.975C10.9167 20.0917 10.6 20 10.3 19.7L3.3 12.725C3.08333 12.5083 2.975 12.2667 2.975 12C2.975 11.7333 3.08333 11.4917 3.3 11.275L10.3 4.3C10.5833 4.01667 10.9 3.93333 11.25 4.05C11.6 4.16667 11.8333 4.4 11.95 4.75C12.0833 5.08333 12 5.4 11.7 5.7L5.425 12L11.7 18.3ZM4 13V11H20C20.4167 11 20.7 11.1667 20.85 11.5C21.0167 11.8333 21.0167 12.1667 20.85 12.5C20.7 12.8333 20.4167 13 20 13H4Z" fill="#222222"/>
        </svg>
      </BackButton>
    </ImageButtonContainer>
      <ContentSection>
